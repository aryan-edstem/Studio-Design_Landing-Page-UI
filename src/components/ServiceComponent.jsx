...
const ServiceComponent = (props) => {
    ...
    return (
        <div className="h-[379px] w-[308px] rounded-[40px] flex flex-col rounded-lg border border-gray-300 bg-white p-5 place-items-center">
            ...
            <p className="text-gray-600 mt-[27px] text-base text-center">{details}</p>
        </div>
    )
}

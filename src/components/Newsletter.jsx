        ...
        <div>
            <div className="flex mx-auto h-[292px] w-[1300px] justify-around bg-[#F4F9FF] rounded-[75px] relative z-20">
                ...
                <div className="flex flex-col place-content-center z-30">
                    <p className="text-black font-normal font-averta leading-normal text-[40px]">Subscribe Newsletter</p>
                    <p className=" text-gray-500 text-base font-averta font-normal leading-6">I will update good news and promotion service not spam</p>
                </div>
                ...
                <img src={rectangle6} className="h-[178px] absolute -bottom-10 -left-10 z-10 overflow-hidden" />
            </div>
        </div>
    )
}
